...
class ShoeDetailFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.cancelButton.setOnClickListener { v: View ->
            v.findNavController().navigate(R.id.action_shoeDetailFrament_to_shoeListFragment_cancel)
        }

        binding.submitButton.setOnClickListener { v: View ->
            v.findNavController().navigate(R.id.action_shoeDetailFrament_to_shoeListFragment_submit)
        }
